...
export default function Header2() {
  return (
    <Popover className="relative bg-white px-4 sm:px-6">
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      ...
                      "px-2 group inline-flex items-center rounded-md bg-white text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-myblue focus:ring-offset-4"
                    )}
                  >
                    <span>About Us</span>
                    <ChevronDownIcon
              ...
              {({ open }) => (
                <>
                  <Popover.Button
                    className={classNames(
                      open ? "text-gray-900" : "text-gray-500",
                      "group inline-flex items-center rounded-md bg-white text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-myblue focus:ring-offset-2"
                    )}
                  >
                      ...
                      <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                        ...
                        <div className="bg-gray-50 px-5 py-5 sm:px-8 sm:py-8">
                          ...
                          <div className="mt-5 text-sm">
                            <a
                              href="#"
                              className="font-medium text-myBlue hover:opacity-50"
                            >
                              View all posts
