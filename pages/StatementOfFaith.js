        ...
        <div className="">
          ...
          <ul className="sm:text-lg list-disc ml-4 space-y-2 sm:space-y-4">
            ...
            <li>
              ...
              love, be holy and care for creation, yet corrupted by sin, which
              incurs divine wrath and judgement.
            </li>
            <li>
              The incarnation of God’s eternal Son, the Lord Jesus Christ-born
              of the virgin Mary; truly divine and truly human, yet without sin.
            </li>
            <li>
              The atoning sacrifice of Christ on the cross: dying in our place,
              paying the price of sin and defeating evil, so reconciling us with
              God.
            </li>
            <li>
            ...
            <li>
              ...
              unites us with Christ through new birth, empowers our discipleship
            ...
            <li>
              ...
              eternal life to the redeemed and eternal condemnation to the lost,
