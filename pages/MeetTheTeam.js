...
const MeetTheTeam = () => {
  return (
    <>
      <Head>
        <title>Meet the team | CityChurch Choucester</title>
        <meta
          name="description"
          content="Meet CityChurch Choucester's team of leaders."
        />
      </Head>
      <div className="mb-24">
          ...
          w-full md:w-1/2 h-[40vh] my-4 rounded-lg overflow-hidden shadow-lg"
            ...
            <div className="md:basis-1/2 lg:basis-2/3  md:p-4">
              ...
              <p className="sm:text-lg">
                ...
                church. He is married to Sarah and together have three young
                boys. John enjoys reading theology books and maintaining his
                garden shed. Sarah loves cooking for her visiting in-laws.
              </p>
            </div>
          </div>
          <div className="md:flex items-end">
          ...
          w-full md:w-1/2 h-[40vh] my-4 rounded-lg overflow-hidden shadow-lg"
            ...
            <div className="md:basis-1/2 lg:basis-2/3  md:p-4">
              ...
              <p className="sm:text-lg">
                ...
                have been part of City Church since the church was first
                started.
              </p>
            </div>
          </div>
