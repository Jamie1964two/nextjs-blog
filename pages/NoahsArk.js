...
const NoahsArk = () => {
  return (
    <>
      <Head>
        <title>Noah's Ark | CityChurch Choucester</title>
        <meta
          name="description"
          content="Introducing our warm and friendly play space for babies and tots."
        />
      </Head>
      <div className="mb-24">
          ...
          w-full md:w-1/2 h-[40vh] my-4 rounded-lg overflow-hidden"
            ...
            <div className="md:basis-1/2 lg:basis-2/3  md:p-4 sm:text-lg space-y-4">
              ...
              <p className="sm:text-lg">
                ...
                children including toys and games, singing, and story times. It
                is also a great context for parents/carers to relax, develop
                friendships and receive support.{" "}
              </p>
              <p>Come and join in, every Friday during school term at 10am.</p>
              <p className="">Get in touch if you'd like to find out more.</p>
              <Link href="/Contact">
