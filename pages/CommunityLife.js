    ...
    <div className="mb-24">
      ...
      <div className="m-4 sm:m-8 mt-6 sm:mt-12">
        ...
        <p className="sm:text-lg">
          ...
          and out unnoticed each week, but we believe Jesus intends more for His
          church than that and we want to help you be apart of it. We believe
          that discipleship happens most efectively in the context of community
          and therefore want to encourage everyone who calls CityChurch their
          home to engage in our community life.
        </p>
      </div>
    </div>
  );
