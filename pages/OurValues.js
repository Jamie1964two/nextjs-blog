    ...
    <div className="mb-24">
      ...
      <div className="m-4 sm:m-8 mt-6 sm:mt-12">
        ...
        <p className="sm:text-lg">
          ...
          disciples. If we get that right, everything else follows. All that we
          do unapologetically serves that goal.
        </p>
        <h1 className="mt-4 sm:mt-8 mb-2 text-gray-700 inline-block text-xl sm:text-2xl font-semibold">
        ...
        <p className="sm:text-lg">
          ...
          salvation and our relationship with Jesus, and not a duty to perform.
        </p>
        <h1 className="mt-4 sm:mt-8 mb-2 text-gray-700 inline-block text-xl sm:text-2xl font-semibold">
        ...
        <p className="sm:text-lg">
          We place high importance on being a community that eagerly encounters
          God through the Baptism of the Holy Spirit and regular encounters with
          Him, study of the Bible, prayer and worship.
        </p>
        <h1 className="mt-4 sm:mt-8 mb-2 text-gray-700 inline-block text-xl sm:text-2xl font-semibold">
        ...
        <p className="sm:text-lg">
          ...
          believe the pursuit of God’s kingdom power is absolute. There is much
          more of God’s kingdom we have yet to see.
        </p>
        <h1 className="mt-4 sm:mt-8 mb-2 text-gray-700 inline-block text-xl sm:text-2xl font-semibold">
        ...
        <p className="sm:text-lg">
          ...
          the grace of God in all situations and on all occasions. The phrase no
          condemnation is not just a theological statement but a living reality
          in all we do without exception.
        </p>
        <h1 className="mt-4 sm:mt-8 mb-2 text-gray-700 inline-block text-xl sm:text-2xl font-semibold">
        ...
        <p className="sm:text-lg">
          Our pursuit of reflecting God’s heart for diversity is non-negotiable.
          We will intentionally celebrate our diversity of backgrounds, ages,
          races and social status and gender
        </p>
        <h1 className="mt-4 sm:mt-8 mb-2 text-gray-700 inline-block text-xl sm:text-2xl font-semibold">
        ...
        <p className="sm:text-lg">
          ...
          opportunities to grow in being open-hearted, open-handed and generous
          with our money.
        </p>
        <h1 className="mt-4 sm:mt-8 mb-2 text-gray-700 inline-block text-xl sm:text-2xl font-semibold">
        ...
        <p className="sm:text-lg">
          ...
          joining us on our adventure. We encourage everyone to a commitment to
          the journey with us into all that God has planned for our good and His
          glory.
        </p>
      </div>
    </div>
