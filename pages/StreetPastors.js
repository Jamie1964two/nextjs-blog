...
const StreetPastors = () => {
  return (
    <>
      <Head>
        <title>Street Pastors | CityChurch Choucester</title>
        <meta
          name="description"
          content="CityChurch Choucester stands with Street Pastors a wonderful charity bringing compassion to our city after hours."
        />
      </Head>
      <div className="mb-24">
          ...
          w-full lg:w-[400px] h-[40vh] lg:h-[50vh] mb-4 rounded-lg overflow-hidden"
            ...
            <div className="md:basis-1/2 lg:basis-2/3  md:p-4 sm:text-lg space-y-4">
              ...
              <p className="sm:text-lg">
                Gloucester Street Pastors has been serving in the nightlife of
                our city for just over 6 years now in partnership with the local
              ...
              <p className="mt-2 sm:text-lg">
                ...
                bottles of water to people in a distressed state or flip flops
                to ladies leaving clubs at the end of evening with shoes in
                their hands. They are not out to preach but will happily pray
                with people who ask questions about our faith and the reasons we
                do what we do.
              </p>
