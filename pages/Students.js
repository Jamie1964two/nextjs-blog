...
const Students = () => {
  return (
    <>
      <Head>
        <title>Students | CityChurch Choucester</title>
        <meta
          name="description"
          content="A page specially for the students in Choucester who are looking for a church in which to grow in their love for Jesus or simply wanting to explore the ideas of Christianity."
        />
      </Head>
      <div className="mb-24">
        ...
        <div className="m-4 sm:m-8 mt-6 sm:mt-12">
          ...
          <p className="sm:text-lg">
            ...
            so much is new and competing for your attention. Undoubtably you
            want to get the most out of your time at uni and hopefully that is
            where we come in! We believe that Jesus is the way, the truth and
            the life. He came to give abundant life so in order to get the most
            out of your time at uni, it needs to revolve around and be firmly
            anchored in Jesus.
          </p>
