...
const Sunday = () => {
  return (
    <>
      <Head>
        <title>Sundays | CityChurch Choucester</title>
        <meta
          name="description"
          content="All the details of CityChurch Choucester's Sunday meetings."
        />
      </Head>
      <div className="mb-24">
        ...
        <div className="m-4 sm:m-8 mt-6 sm:mt-12">
          ...
          <p className="mb-4 sm:text-lg">
            ...
            you’ve yet to visit, we hope to see you at one of our Sunday
            meetings soon.
          </p>
          <p className="mb-4 sm:text-lg">
          ...
          <div className="flex mt-4">
            ...
            <div className="ml-2 sm:text-lg">
              ...
              <p className="text-gray-500">
                We have a fantastic programme for children and young people.
                Visit our Children’s Work and Youth pages for more information.
              </p>
            </div>
          </div>
          ...
          <div className="flex mt-4">
            ...
            <div className="ml-2 sm:text-lg">
              ...
              <p className="text-gray-500">
                You are welcome at City Church just as you are. You’ll see
                people in jeans and t-shirt, in shirt and tie, and everywhere in
                between!
              </p>
            </div>
          </div>
          ...
          <div className="flex mt-4">
            ...
            <div className="ml-2 sm:text-lg">
              ...
              <p className="text-gray-500">
                You can sit wherever you feel comfortable. If you have
                difficulty locating a seat or need assistance, the Welcome Team
