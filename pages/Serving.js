    ...
    <div className="mb-24">
      ...
      <div className="m-4 sm:m-8 mt-6 sm:mt-12">
        ...
        <p className="mb-4 sm:text-lg">
          ...
          it says. Anyone who listens to the word but does not do what it says
        ...
        <p className="mb-4 sm:text-lg">
          ...
          passion to work with children and young people, or are keen to explore
          working in other cultures overseas. We would love to encourage your
          participation in each of these areas plus many more.
        </p>
        <p className="mb-4 sm:text-lg">
