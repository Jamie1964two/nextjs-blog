        ...
        <div className="flex">
          <div className="basis-1/2 md:basis-2/3">
            ...
            <p className="mb-6 sm:text-lg">
              At City Church our Children’s activities are built around a simple
              concept: Jesus is the hero. Our vision is to work alongside
              parents to lay a foundation in our children’s lives to see them
              become fully devoted to God and get excited about what God has
              planned for their lives. We hope to engage children in a church
              they want to be a part of and feel they belong to.
            </p>
            <h1 className="mr-2 mb-2 sm:mb-4 sm:mr-4 text-gray-500 inline-block text-2xl sm:text-4xl font-medium">
              New?
            </h1>
            <p className="mb-6 sm:text-lg">
              ...
              group meet. The children stay in the main meeting for the first 20
              minutes of worship, a message will appear on the screens to let
              you know when to take them to their groups.
            </p>
          </div>
