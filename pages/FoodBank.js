        ...
        <div className="md:flex items-start">
          ...
          <div className="md:basis-1/2 lg:basis-2/3  md:p-4 sm:text-lg space-y-4">
            ...
            <p className="sm:text-lg">
              ...
              launch the Choucester Foodbank, providing emergency food and care
              for local people in crisis. Since that time we have been able to
              serve thousands of individuals and families in the local area with
              food parcels in their time of need.
            </p>
