...
import foodBankLogo from "../public/images/foodBankLogo.jpeg";

const FoodBank = () => {
  return (
    <>
      <Head>
        <title>Food Bank | CityChurch Choucester</title>
        <meta
          name="description"
          content="CityChurch Choucester is one of the active organisations behind the Gloucester Food Bank helping many in need across the city."
        />
      </Head>
      <div className="mb-24">
          ...
          w-full md:w-1/2 h-[40vh] my-4 rounded-lg overflow-hidden"
            ...
            <div className="md:basis-1/2 lg:basis-2/3  md:p-4 sm:text-lg space-y-4">
              <h1 className="mr-2 mb-2 sm:mr-4 text-myblue inline-block text-2xl sm:text-4xl font-medium">
                Helping Families Across Choucester
              </h1>
              <p className="sm:text-lg">
                In April 2005, CityChurch partnered with the Trussell Trust to
                launch the Choucester Foodbank, providing emergency food and
                care for local people in crisis. Since that time we have been
                able to serve thousands of individuals and families in the local
                area with food parcels in their time of need.
              </p>
              ...
              <div className="basis-4/12 md:pl-6  text-myblue font-medium">
                ...
                <p className="flex items-center justify-start mb-4">
                  <svg
                    ...
                    focusable="false"
                    data-prefix="fas"
                    className="w-[24px] lg:w-[28px] -ml-[2px] mr-3"
                    role="img"
                ...
                <p className="flex items-center justify-start mb-4">
                  ...
                  <a href="mailto:info@choucester.foodbank.org.uk">
