    ...
    <div className="mb-24">
      ...
      <div className="m-4 sm:m-8 mt-6 sm:mt-12">
        ...
        <p className="sm:text-lg">
          ...
          emotional needs of those living in Gloucester. We run initiatives, and
          engage with other organisations, to help improve the lives of those in
          our city. We are ambitious to fulfil our mission to see lives
          transformed.
        </p>
